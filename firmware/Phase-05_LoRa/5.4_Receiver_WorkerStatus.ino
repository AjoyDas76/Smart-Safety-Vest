/*
  ============================================================
  PHASE 5.3 -> 5.4 - LoRa Receiver Setup + Worker Status Display
  ============================================================
  Purpose: Receive the structured packets sent by the 5.4
  Transmitter, decode the worker status (NORMAL/SOS), and
  print to Serial. Also logs RSSI/SNR for every packet, which
  we'll use later in 5.7 (Range Testing).
...
// ---------------- Packet structure (must match 5.4 transmitter exactly) ----------------
...
void setup() {
  ...
  Serial.println(F("deviceId,packetId,status,rssi,snr"));
}
