/*
  ============================================================
  PHASE 5.3 - LoRa Receiver Setup (Base Station)
  ============================================================
  Purpose: Receive the structured packets sent by the 5.2
  Transmitter, parse them, and print to Serial. Also logs
  RSSI/SNR for every packet, which we'll use later in
  5.7 (Range Testing).
...
// ---------------- Packet structure (must match 5.2 transmitter exactly) ----------------
...
void loop() {
  ...
  Serial.print(pkt.status);     Serial.print(',');
